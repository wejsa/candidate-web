...
export const metadata: Metadata = {
  title: '엔지니어 채용',
  description:
    'Hoji는 세상을 움직이는 플랫폼을 설계하고 운영합니다. 미션 크리티컬한 시스템을 함께 만들 엔지니어를 찾습니다.',
  openGraph: {
    title: 'Hoji 엔지니어 채용',
    description: '세상을 움직이는 플랫폼을 함께 만들 엔지니어를 찾습니다.',
    type: 'website',
  },
};
...
const VALUES = [
  {
    title: '세상을 움직이는 인프라',
    desc: '사용자 접점부터 정산 백엔드까지, 사람 손에 닿는 흐름 전체를 설계하고 운영합니다.',
    icon: (
    ...
    <main id="main-content" className={styles.home}>
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          ...
          <h1 className={styles.title}>함께 세상을 움직일 엔지니어를 찾습니다</h1>
          <p className={styles.subtitle}>
            세상을 움직이는 플랫폼을 직접 설계하고 운영하세요. Spring Boot부터 Next.js까지, 미션 크리티컬한
