import { z } from 'zod';
// CANDID-017 Step 1: isPrivateOrMetadataHost를 lib/security/ssrf-guard로 이관 (모듈 승격).
// 본 모듈은 S3_ENDPOINT 검증 컨텍스트에서 *재사용*만 한다 — 정의 SSOT는 ssrf-guard.
import { isPrivateOrMetadataHost } from '@/lib/security/ssrf-guard';
